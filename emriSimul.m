...
realignedKsp = correctPhaseUnlcockedKsp(phaseUnlockedKsp,xdim,numKsamples);
...
function realignedKsp = correctPhaseUnlcockedKsp(phaseUnlockedKsp,xdim,numKsamples)
